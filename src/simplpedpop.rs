...
pub mod round2 {
    ...
    pub fn run<T: SigningTranscript + Clone>(
        ...
        Ok((public_data, messages, participants))
    }
...
pub mod round3 {
    ...
    pub fn run<T: SigningTranscript + Clone>(
        ...
        validate_messages(parameters, round2_public_messages, round1_public_messages)?;
...
mod tests {
    ...
    fn round3(
        ...
        participants_round1_public_messages: &Vec<BTreeSet<round1::PublicMessage>>,
